...
function Project(props) {
    ...
    return (<main style={{animationTimeline:'view()'}} className={`${theme === 'light' ? '   border-gray-300' : 'border-gray-500'}  autoShow  border-b  pb-6 md:pb-3  lg:pb-6  flex flex-col md:flex-row gap-5   `}>
